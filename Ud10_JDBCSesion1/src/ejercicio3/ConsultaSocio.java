...
public class ConsultaSocio extends JFrame implements ActionListener {
	...
	private void posicion(ResultSet o) {
		try {
			texto.setText("Socio " + String.valueOf(o.getRow()) + " de "
					+ String.valueOf(abd3.consultarTodosSocios().size()));
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	private void anterior(ResultSet o) {
		try {
			if (o.previous()) {
				socioT.setText(o.getString(1));
				nombreT.setText(o.getString(2));
	...
	private void datos(ResultSet o) {
		try {
			{
				socioT.setText(o.getString(1));
				nombreT.setText(o.getString(2));
